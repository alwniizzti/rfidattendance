...
CREATE TABLE `guard` (
  ...
  `guard_email` varchar(80) NOT NULL,
  `guard_pwd` longtext NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
--
INSERT INTO
  `admin` (`id`, `admin_name`, `admin_email`, `admin_pwd`)
VALUES
  (
    1,
    'Admin',
    'admin@gmail.com',
    '$2y$10$89uX3LBy4mlU/DcBveQ1l.32nSianDP/E1MfUh.Z.6B4Z0ql3y7PK'
  );
